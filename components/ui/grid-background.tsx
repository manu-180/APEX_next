    ...
    <div className={cn('pointer-events-none absolute inset-0 overflow-hidden', className)}>
        ...
        <div
          ...
          style={{
            background: `
              ...
              radial-gradient(ellipse 60% 30% at 50% 0%, rgba(var(--color-accent-rgb), 0.05), transparent 60%)
            `,
          }}
        />
      )}
      ...
      {showScanline && (
        <div
          ...
          style={{
            background: 'linear-gradient(to right, transparent, rgba(var(--color-accent-rgb), 0.08), transparent)',
          }}
        />
      )}
