    ...
    >
      <button
        ...
        className={cn(
          ...
          'rounded-full',
          // Alto fijo (avatar 40px + py-2) → al colapsar el ancho cae a 56px = círculo.
          // NO usar aspect-square: ataría el alto al ancho aún expandido y el botón
          // se inflaría a un círculo gigante antes de encoger (animación buggeada).
          'h-14 min-h-[3.5rem]',
