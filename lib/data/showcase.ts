...
export const SHOWCASE_TIERS: ShowcaseTier[] = [
  ...
  },
  {
    ...
    sites: [
      ...
      {
        slug: 'apostillas',
        name: 'Apostillas Argentinas Online',
        url: 'https://www.apostillasargentinasonline.com/',
        domain: 'apostillasargentinasonline.com',
        blurb:
          'Gestoría online de apostillas: catálogo de trámites, proceso guiado en 4 pasos y cotización directa por WhatsApp.',
        highlights: ['Catálogo de trámites', 'Proceso en 4 pasos', 'Cotización por WhatsApp'],
        kind: 'client',
      },
    ],
  },
