...
export function ServiciosStaticTop() {
  return (
    <>
      ...
      <div className="my-16 mx-auto max-w-4xl px-6">
        <SectionReveal>
          <div className="glass-card rounded-2xl overflow-hidden">
            <div
              className="h-[2px] w-full"
              style={{
                background: 'linear-gradient(90deg, transparent, rgba(var(--color-primary-rgb), 0.7) 50%, transparent)',
              }}
            />
            <div className="p-8">
              <div className="flex flex-col sm:flex-row sm:items-center gap-8">
                ...
                <div className="flex-1">
                  <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[var(--color-primary)] mb-4">
                    Confiaron en APEX
                  </p>
                  <div className="flex flex-wrap gap-3">
                    {[
                      { label: 'mnltecno.com',       href: 'https://mnltecno.com' },
                      { label: 'tallerceramica.com',  href: 'https://tallerceramica.com' },
                      { label: 'bylumainvita.com',    href: 'https://bylumainvita.com' },
                    ].map(({ label, href }) => (
                      <a
                        key={label}
                        href={href}
                        ...
                        className={cn(
                          'group inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium',
                          'transition-all duration-200',
                          'client-pill',
                        )}
                      >
                        <span className="client-pill__dot size-1.5 rounded-full flex-shrink-0" />
                        {label}
                        <svg
                          ...
                          className="size-3 opacity-50 transition-opacity duration-200 group-hover:opacity-100"
                          aria-hidden
                        >
                ...
                {/* Right: quote */}
                <blockquote className="flex-1 max-w-xs">
                  <div
                    className="w-6 h-[2px] mb-3 rounded-full"
                  ...
                  <footer className="text-xs text-[var(--color-on-surface-variant)] opacity-50 mt-2.5 not-italic">
                    — Simón R., Coach
                  </footer>
                </blockquote>
              </div>
